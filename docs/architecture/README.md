...
- [Data Format Specification](/docs/architecture/DATA_FORMAT.md) - Ethereum block schema
- [Real-Time Collector](/docs/deployment/realtime-collector.md) - VM deployment
